...
class RNNModel(NERModel):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(lookup_res, (-1, self.max_length, 
    ...
    def add_loss_op(self, preds):
        ...
        loss = tf.nn.sparse_softmax_cross_entropy_with_logits(
            ...
            logits=preds)
        mask_loss = tf.boolean_mask(loss, self.mask_placeholder)
        loss = tf.reduce_mean(mask_loss)
        ### END YOUR CODE
        return loss
